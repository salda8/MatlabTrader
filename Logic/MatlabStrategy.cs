...
namespace MATLAB_trader.Logic
{
    internal class MatlabStrategy : IStrategy
    {
        ...
        public static string MatlabFunction { get; set; } = "[Vysledek2,DataImport,DataImport2] = CreatePort(a1,a2,a3,a4,a5,Equity, p)";
        ...
        private void UpdateMatlabParameterInDatabase(MatlabValue mv)
        {
        ...
        private void AddMatlabParameterInDatabase(MatlabValue mv)
        {
            using (var con = Db.OpenConnection())
            {
                using (var cmd = con.CreateCommand())
        ...
        private void GetAndPutWorkSpaceData(DateTime dt, IbClient wrapper)
        {
            ...
            foreach (var barSettings in Data.Data.BarSettings)
            {
                ...
                List<MinuteBar> list = new List<MinuteBar>();
